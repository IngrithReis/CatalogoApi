        ...
        private List<Produto> _produtos = new List<Produto>()
            {
                ...
                { new Produto() { Id = 2, Cor = "Marinho", Nome="Liquidificador", Descricao = "liquidificador masterplus", Marca="Philco", Preco = 130.45M, EAN ="123456710", QtdDisponivel = 10 }},
                ...
                { new Produto() { Id = 7, Cor = "Preta", Nome="Notebook", Descricao = "Notebook", Marca="Sansung", Preco = 2320.25M, EAN ="123456713", QtdDisponivel = 22 }}
            };
